...
Original file is located at
    https://colab.research.google.com/drive/1zw7yTWbwqQw-3khyNdzzzTPrjZLVPC7L
...
# WAV 파일을 22050Hz로 변환
input_wav_dir = "/content/TTS/filelists/wavs/"
output_wav_dir = "/content/TTS/filelists/wavs_22050/"
...
# WAV 파일 변환
for wav_file in os.listdir(input_wav_dir):
    if wav_file.endswith(".wav"):
        audio = AudioSegment.from_wav(os.path.join(input_wav_dir, wav_file))
        audio = audio.set_frame_rate(22050)  # 샘플레이트를 22050Hz로 설정
        audio.export(os.path.join(output_wav_dir, wav_file), format="wav")

# 변환된 파일로 compute_statistics.py 실행
if not Path("/content/drive/My Drive/Colab Notebooks/data/glowtts-v2/scale_stats_new.npy").exists():
    !/content/tts_env/bin/pip install pydub  # pydub 설치
    !/content/tts_env/bin/python TTS/bin/compute_statistics.py \
        ...
        --data_path "/content/TTS/filelists/wavs_22050/"
...
!/content/tts_env/bin/python TTS/bin/train_glow_tts.py \
...
!/content/tts_env/bin/python TTS/bin/train_glow_tts.py \
    --continue_path "/content/drive/My Drive/Colab Notebooks/data/glowtts-v2/glowtts-v2-June-18-2025_06+37AM-3aa165a"
